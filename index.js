...
function GraphemeSplitter(){
	...
	function getGraphemeBreakProperty(code){
		...
		if(
			markNClassifier.match(code) ||
			markEClassifier.match(code)
		){
			return Extend;
		}
		...
		if(
			lvClassifier.match(code)
		){
			return LV;
		}

		if(
			lvtClassifier.match(code)
		){
			return LVT;
		}
